...
def inputPlayerLetter():
    ...
    Return a list with the player's letter as the first item,
    and the computer's letter as a the second"""
    letter = ''
...
def isWinner(bo, le):
    ...
    return ((bo[7] == le and bo[8] == le and bo [9] == le) or #across the top
            ...
            (bo[7] == le and bo[4] == le and bo[1] == le) or #down to the left side
            (bo[8] == le and bo[5] == le and bo[2] == le) or #down the middle
            (bo[9] == le and bo[6] == le and bo[3] == le) or #down to the right side
